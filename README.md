...
The envelope deliberately omits absolute paths, credentials, environment-variable values, identity, authorization, and unselected runtime behavior. A valid v0.1.0 receipt remains verifiable; new v0.1.1 receipts require the envelope.
...
`v0.1.1` is the current private candidate. Publication requires fresh activation, schema, receipt, CI-example, and frozen-candidate validation evidence.
